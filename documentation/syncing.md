...
Inside the physicsref folder, run the following command to compile the reference pages into `.html` files
...
```
C:\Users\<user>\Documents\GitHub\pl-tam210\clientFilesCourse\physicsref
```
...
Run the following command inside the physicsref folder, where &lt;MR_LOC&gt; is the location of the physicsref repository on your computer. By default, it should be `$HOME/Documents/GitHub`.
